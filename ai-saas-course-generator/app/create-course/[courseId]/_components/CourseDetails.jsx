    ...
    return (
        <div className='grid grid-cols-2 md:grid-cols-3'>
            <div className='grid grid-cols-2 md:grid-cols-4'>
                ...
                <div>
                    <h2 className='text-xs text text-gray-500'>Skill Level</h2>
                ...
                <div>
                    <h2 className='text-xs text text-gray-500'>Duration</h2>
                ...
                <div>
                    <h2 className='text-xs text text-gray-500'>Number Of Chapters</h2>
                ...
                <div>
                    <h2 className='text-xs text text-gray-500'>Video Included?</h2>
